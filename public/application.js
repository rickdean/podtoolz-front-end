...
/***/ function(module, exports, __webpack_require__) {
	...
	var itemEvents = __webpack_require__(10);
	var softwareTemplate = __webpack_require__(33);
	var equipmentTemplate = __webpack_require__(34);
	var peripheralTemplate = __webpack_require__(35);
	var itunesTemplate = __webpack_require__(36);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onChangePassword = function onChangePassword(event) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  api.changePassword(data).then(ui.passSuccess).catch(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onAddItem = function onAddItem(event) {
	  ...
	  api.addItem(data).then(ui.addItemSuccess).catch(ui.addItemFail);
	};

	var onGetList = function onGetList() {
	  //event.preventDefault();
	  // console.log('click get list button');
	  api.getList().then(ui.getListSuccess).catch(ui.failure);
	};
	...
	var onUpdateItem = function onUpdateItem(event) {
	  ...
	  api.updateItem(data, id).then(ui.updateItemSuccess).then(function () {
	    onGetList();
	  }).catch(ui.failure);
	};

	var onCloseSuccess = function closeSuccess() {
	  event.preventDefault();
	  $('.add-success').hide();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var wishListTemplate = __webpack_require__(13);

	var getListSuccess = function getListSuccess(items) {
	...
	var addItemFail = function addItemFail() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <table class=\"table table-reflow listTable\" data-id= "
	    ...
	    + "<button data-id= "
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + " class=\"btn btn-link comment\" data-toggle=\"modal\" data-target=\"#addCommentModal\">Add Comment</button></td>\n      </tr>\n      <tr>\n        <td class='row'><button data-id= "
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + " class=\"btn btn-danger btn-link delete\" data-toggle=\"modal\" data-target=\"#confirmDeleteModal\">Delete</button>\n        </td>\n      </tr>\n    </tbody>\n  </table>\n\n\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"container-fluid software-cont\">\n  <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\" id=\"closeButton\">X</button>\n  <div class=\"divTable\">\n    <div class=\"divTableBody\">\n      <div class=\"divTableRow\">\n        <div class=\"divTableCell\" id=\"hj-trans\">\n          <form class=\"addItemButton\">\n            <div class=\"form-group\">\n              <input type=\"text\" class=\"title-font\" name=\"item[name]\" value=\"Hindenburg Journalist\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"text\" class=\"price-font\" name=\"item[price]\" value=\"$95.00\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"hidden\" class=\"url-font\" name=\"item[url]\" value=\"http://hindenburg.com\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"hidden\" name=\"item[category]\" value=\"Software\" readonly>\n            </div>\n            <button type=\"button\" class=\"btn btn-link info-font\" data-toggle=\"modal\" data-target=\"#hindenburg-modal\">More Information</button>\n            <br>\n            <button class=\"btn btn-success adder\" type=\"submit\"><span class=\"glyphicon glyphicon-plus\"></span>Add to List</button>\n          </form>\n\n        </div>\n        <div class=\"divTableCell\" id=\"gb-trans\">\n          <form class=\"addItemButton\">\n            <div class=\"form-group\">\n              <input type=\"text\" class=\"title-font\" name=\"item[name]\" value=\"GarageBand\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"text\" class=\"price-font\" name=\"item[price]\" value=\"FREE\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"hidden\" name=\"item[category]\" value=\"Software\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"hidden\" class=\"url-font\" name=\"item[url]\" value=\"http://www.apple.com/mac/garageband/\" readonly>\n            </div>\n            <button type=\"button\" class=\"btn btn-link info-font\" data-toggle=\"modal\" data-target=\"#gb-modal\">More Information</button>\n            <br>\n            <button class=\"btn btn-success adder\" type=\"submit\"><span class=\"glyphicon glyphicon-plus\"></span>Add to List</button>\n          </form>\n        </div>\n        <div class=\"divTableCell\" id=\"aud-trans\">\n          <form class=\"addItemButton\">\n            <div class=\"form-group\">\n              <input type=\"text\" class=\"title-font\" name=\"item[name]\" value=\"Audacity\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"text\" class=\"price-font\" name=\"item[price]\" value=\"FREE\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"hidden\" name=\"item[category]\" value=\"Software\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"hidden\" class=\"url-font\" name=\"item[url]\" value=\"http://www.audacityteam.org/\" readonly>\n            </div>\n            <button type=\"button\" class=\"btn btn-link info-font\" data-toggle=\"modal\" data-target=\"#audacity-modal\">More Information</button>\n            <br>\n            <button class=\"btn btn-success adder\" type=\"submit\"><span class=\"glyphicon glyphicon-plus\"></span>Add to List</button>\n          </form>\n        </div>\n        <div class=\"divTableCell\" id=\"iz-trans\">\n          <form class=\"addItemButton\">\n            <div class=\"form-group\">\n              <input type=\"text\" class=\"title-font\" name=\"item[name]\" value=\"RX5\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"text\" class=\"price-font\" name=\"item[price]\" value=\"$349.99\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"hidden\" name=\"item[category]\" value=\"Software\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"hidden\" class=\"url-font\" name=\"item[url]\" value=\"https://www.izotope.com/en/products/repair-and-edit/rx.html\" readonly>\n            </div>\n            <button type=\"button\" class=\"btn btn-link info-font\" data-toggle=\"modal\" data-target=\"#rx5-modal\">More Information</button>\n            <br>\n            <button class=\"btn btn-success adder\" type=\"submit\"><span class=\"glyphicon glyphicon-plus\"></span>Add to List</button>\n          </form>\n        </div>\n      </div>\n      <div class=\"divTableRow\">\n        <div class=\"divTableCell\" id=\"scriv-trans\">\n          <form class=\"addItemButton\">\n            <div class=\"form-group\">\n              <input type=\"text\" class=\"title-font\" name=\"item[name]\" value=\"Scrivener\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"text\" class=\"price-font\" name=\"item[price]\" value=\"$45.00\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"hidden\" name=\"item[category]\" value=\"Software\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"hidden\" class=\"url-font\" name=\"item[url]\" value=\"https://www.literatureandlatte.com/scrivener.php\" readonly>\n            </div>\n            <button type=\"button\" class=\"btn btn-link info-font\" data-toggle=\"modal\" data-target=\"#scriv-modal\">More Information</button>\n            <br>\n            <button class=\"btn btn-success adder\" type=\"submit\"><span class=\"glyphicon glyphicon-plus\"></span>Add to List</button>\n          </form>\n        </div>\n        <div class=\"divTableCell\">&nbsp;</div>\n        <div class=\"divTableCell\">&nbsp;</div>\n        <div class=\"divTableCell\">&nbsp;</div>\n      </div>\n    </div>\n  </div>\n  <!-- DivTable.com -->\n  <!-- /.row -->\n</div>\n\n\n<!--  Hindenburg -->\n<div class=\"modal fade\" id=\"hindenburg-modal\">\n  <div class=\"modal-dialog\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">×</button>\n        <h4 class=\"modal-title\">Hindenburg Journalist</h4>\n      </div>\n      <div class=\"modal-body\">\n        <div class=\"pos section\">\n          <div class=\"vis pos-2 size cont\">\n            <div class=\"vis pos-3 size-2 colwrapper\">\n              <div class=\"vis pos-3 size-3 cont\">\n                <picture class=\"img-2\">\n                  <source srcset=\"https://s3.amazonaws.com/podtools/hj.png\">\n                  <img src=\"https://s3.amazonaws.com/podtools/hj.png\" alt=\"\" class=\"js img-logo\">\n                </picture>\n              </div>\n              <div class=\"vis pos-4 size-4 cont\">\n                <div class=\"cont\">\n                  <p class=\"link-font\"><a target=\"_blank\" href=\"http://hindenburg.com\">http://hindenburg.com</a></p>\n                </div>\n              </div>\n              <div class=\"vis pos-5 size-5 cont\">\n                <div class=\"vis pos-6 size-6 cont-2\">\n                  <div class=\"cont\">\n                    <p class=\"rick-font\">Rick's Pick</p>\n                  </div>\n                </div>\n                <div class=\"vis pos-7 size-7 cont-3\">\n                  <picture class=\"img-4\">\n                    <source srcset=\"https://s3.amazonaws.com/podtools/ok-512.png\">\n                    <img src=\"https://s3.amazonaws.com/podtools/ok-512.png\" alt=\"\" class=\"js-2 img-checkmark\">\n                  </picture>\n                </div>\n                <br>\n                <div class=\"vis pos-8 size-6 cont-4\">\n                </div>\n              </div>\n            </div>\n            <div class=\"vis pos-9 size-8 cont\">\n              <div class=\"cont\">\n                <p class=\"para\">\n                  An incredibly powerful DAW (Digital Audio Workstation) for mixing, editing, and pretty much anything else you want to do. As a podcasting solution it’s one of the best (if not the best for its intended purpose). Record Skype calls, match voice profiles,\n                  or hook it up to your favorite plugin, Hindenburg Journalist will not disappoint. It comes in two flavors, <span style=\"font-weight:bold\">Basic</span> and <span style=\"font-weight:bold\">Pro</span>. For most users Basic\n                  will do the job. At <span style=\"color:red\">$95</span> it is a little pricey but it delivers and is much cheaper than other solutions (can you say ProTools?).\n                </p>\n              </div>\n              <div class=\"modal-footer\">\n                <button type=\"button\" class=\"btn btn-default reset\" data-dismiss=\"modal\">Close</button>\n                <p>&copy; 2017 Rick Coste Productions, Inc. </p>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n\n</div>\n\n\n<!--  GB -->\n<div class=\"modal fade\" id=\"gb-modal\">\n  <div class=\"modal-dialog\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">×</button>\n        <h4 class=\"modal-title\">GarageBand</h4>\n      </div>\n      <div class=\"modal-body\">\n        <div class=\"pos section\">\n          <div class=\"vis pos-2 size cont\">\n            <div class=\"vis pos-3 size-2 colwrapper\">\n              <div class=\"vis pos-3 size-3 cont\">\n                <picture class=\"img-2\">\n                  <source srcset=\"https://s3.amazonaws.com/podtools/garageband.png\">\n                  <img src=\"https://s3.amazonaws.com/podtools/garageband.png\" alt=\"\" class=\"js img-logo\">\n                </picture>\n              </div>\n              <div class=\"vis pos-4 size-4 cont\">\n                <div class=\"cont\">\n                  <p class=\"link-font\"><a target=\"_blank\" href=\"http://www.apple.com/mac/garageband/\">http://www.apple.com/mac/garageband/</a></p>\n                </div>\n              </div>\n              <div class=\"vis pos-5 size-5 cont\">\n                <div class=\"vis pos-6 size-6 cont-2\">\n                </div>\n                <br>\n                <div class=\"vis pos-8 size-6 cont-4\">\n                </div>\n              </div>\n            </div>\n            <div class=\"vis pos-9 size-8 cont\">\n              <div class=\"cont\">\n                <p class=\"para\">\n                  I’m a big fan of GarageBand as that is where I started. There is not much that you can’t do with it when it comes to podcast production (and music for that matter). A good portion of my science series <span style=\"font-style:italic\"> Evolution Talk</span>                  was produced using GarageBand before I made the switch to Hindenburg. I still go back to GarageBand to take advantage of some of the features (such as panning) which Hindenburg doesn’t support. To sweeten the deal GarageBand is\n                  <span style=\"color:red\">FREE</span>! That’s if you’re a Mac user of course. And while we are on the subject of free you can also edit your audio files using <a href=\"http://www.audacityteam.org/\">Audacity</a> before mixing them with\n                  GarageBand. Up until I purchased the <a href=\"https://www.izotope.com/en/products/repair-and-edit/rx.html\">RX5 Audio Editor</a> from iZotope I used Audacity for all of my pre-mixing initial audio editing.\n\n                </p>\n              </div>\n              <div class=\"modal-footer\">\n                <button type=\"button\" class=\"btn btn-default reset\" data-dismiss=\"modal\">Close</button>\n                <p>&copy; 2017 Rick Coste Productions, Inc. </p>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n\n\n<!--  Audacity -->\n<div class=\"modal fade\" id=\"audacity-modal\">\n  <div class=\"modal-dialog\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">×</button>\n        <h4 class=\"modal-title\">Audacity</h4>\n      </div>\n      <div class=\"modal-body\">\n        <div class=\"pos section\">\n          <div class=\"vis pos-2 size cont\">\n            <div class=\"vis pos-3 size-2 colwrapper\">\n              <div class=\"vis pos-3 size-3 cont\">\n                <picture class=\"img-2\">\n                  <source srcset=\"https://s3.amazonaws.com/podtools/audacity-logo.png\">\n                  <img src=\"https://s3.amazonaws.com/podtools/audacity-logo.png\" alt=\"\" class=\"js img-logo\">\n                </picture>\n              </div>\n              <div class=\"vis pos-4 size-4 cont\">\n                <div class=\"cont\">\n                  <p class=\"link-font\"><a target=\"_blank\" href=\"http://www.audacityteam.org/\">http://www.audacityteam.org/</a></p>\n                </div>\n              </div>\n              <div class=\"vis pos-5 size-5 cont\">\n                <div class=\"vis pos-6 size-6 cont-2\">\n                </div>\n                <br>\n                <div class=\"vis pos-8 size-6 cont-4\">\n                </div>\n              </div>\n            </div>\n            <div class=\"vis pos-9 size-8 cont\">\n              <div class=\"cont\">\n                <p class=\"para\">\n                  You’ll often hear the words “you get what you paid for\" when describing something that’s <span style=\"color:red\">FREE</span>. While that may often be the case it’s not when it comes to Audacity. Audacity performs almost all of the audio\n                  duties that the major software packages accomplish, and it does all of this while also allowing for multiple track mixing! I used Audacity for years to perform initial audio editing (cutting, deleting, pasting, reverb, low filter\n                  passes, etc). I have to say that I wouldn’t hesitate to use it again. And did I say it was <span style=\"color:red\">FREE</span>?\n\n                </p>\n              </div>\n              <div class=\"modal-footer\">\n                <button type=\"button\" class=\"btn btn-default reset\" data-dismiss=\"modal\">Close</button>\n                <p>&copy; 2017 Rick Coste Productions, Inc. </p>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n\n<!--  RX5 -->\n<div class=\"modal fade\" id=\"rx5-modal\">\n  <div class=\"modal-dialog\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">×</button>\n        <h4 class=\"modal-title\">RX5</h4>\n      </div>\n      <div class=\"modal-body\">\n        <div class=\"pos section\">\n          <div class=\"vis pos-2 size cont\">\n            <div class=\"vis pos-3 size-2 colwrapper\">\n              <div class=\"vis pos-3 size-3 cont\">\n                <picture class=\"img-2\">\n                  <source srcset=\"https://s3.amazonaws.com/podtools/izotopelogo.jpg\">\n                  <img src=\"https://s3.amazonaws.com/podtools/izotopelogo.jpg\" alt=\"\" class=\"js img-logo\">\n                </picture>\n              </div>\n              <div class=\"vis pos-4 size-4 cont\">\n                <div class=\"cont\">\n                  <p class=\"link-font\"><a target=\"_blank\" href=\"https://www.izotope.com/en/products/repair-and-edit/rx.html\">https://www.izotope.com/en/products/repair-and-edit/rx.html</a></p>\n                </div>\n              </div>\n              <div class=\"vis pos-5 size-5 cont\">\n                <div class=\"vis pos-6 size-6 cont-2\">\n                </div>\n                <div class=\"cont\">\n                  <p class=\"rick-font\">Rick's Pick</p>\n                </div>\n              </div>\n              <div class=\"vis pos-7 size-7 cont-3\">\n                <picture class=\"img-4\">\n                  <source srcset=\"https://s3.amazonaws.com/podtools/ok-512.png\">\n                  <img src=\"https://s3.amazonaws.com/podtools/ok-512.png\" alt=\"\" class=\"js-2 img-checkmark\">\n                </picture>\n              </div>\n              <br>\n              <div class=\"vis pos-8 size-6 cont-4\">\n              </div>\n            </div>\n          </div>\n          <div class=\"vis pos-9 size-8 cont\">\n            <div class=\"cont\">\n              <p class=\"para\">\n                What can I say? I’m in love with RX5. It took me a while to save my pennies while I waited for iZotope to offer a discounted price, but when I first fired it up it was a game-changer. Not only did it not take long to get up to speed with what it can do\n                (it has a number of presets) but I continue to be impressed by its power as an audio editing tool. Instead of tool think magic wand. It can remove even the most stubborn background noise that other solutions can’t seem to touch without\n                significant sound degradation. It comes in Basic and Advanced. The Basic still comes at a steep <span style=\"color:red\">$349.99</span> price tag while the Advanced costs <span style=\"color:red\">$1199</span>. I sprung for\n                the advanced during a special offer but the Basic has most everything you will need.\n\n              </p>\n            </div>\n            <div class=\"modal-footer\">\n              <button type=\"button\" class=\"btn btn-default reset\" data-dismiss=\"modal\">Close</button>\n              <p>&copy; 2017 Rick Coste Productions, Inc. </p>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n</div>\n\n<!--  Scrivener -->\n<div class=\"modal fade\" id=\"scriv-modal\">\n  <div class=\"modal-dialog\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">×</button>\n        <h4 class=\"modal-title\">Scrivener</h4>\n      </div>\n      <div class=\"modal-body\">\n        <div class=\"pos section\">\n          <div class=\"vis pos-2 size cont\">\n            <div class=\"vis pos-3 size-2 colwrapper\">\n              <div class=\"vis pos-3 size-3 cont\">\n                <picture class=\"img-2\">\n                  <source srcset=\"https://s3.amazonaws.com/podtools/scrivener-logo.png\">\n                  <img src=\"https://s3.amazonaws.com/podtools/scrivener-logo.png\" alt=\"\" class=\"js img-logo\">\n                </picture>\n              </div>\n              <div class=\"vis pos-4 size-4 cont\">\n                <div class=\"cont\">\n                  <p class=\"link-font\"><a target=\"_blank\" href=\"https://www.literatureandlatte.com/scrivener.php\">https://www.literatureandlatte.com/scrivener.php</a></p>\n                </div>\n              </div>\n              <div class=\"vis pos-5 size-5 cont\">\n                <div class=\"vis pos-6 size-6 cont-2\">\n                </div>\n                <div class=\"cont\">\n                  <p class=\"rick-font\">Rick's Pick</p>\n                </div>\n              </div>\n              <div class=\"vis pos-7 size-7 cont-3\">\n                <picture class=\"img-4\">\n                  <source srcset=\"https://s3.amazonaws.com/podtools/ok-512.png\">\n                  <img src=\"https://s3.amazonaws.com/podtools/ok-512.png\" alt=\"\" class=\"js-2 img-checkmark\">\n                </picture>\n              </div>\n              <br>\n              <div class=\"vis pos-8 size-6 cont-4\">\n              </div>\n            </div>\n          </div>\n          <div class=\"vis pos-9 size-8 cont\">\n            <div class=\"cont\">\n              <p class=\"para\">\n                I write. A lot. I have used many tools over the years to do so as well. You name it I’ve probably tried it. I began using Scrivener a few years ago when it was in beta. Even back then it was powerful. Today it is amazing, with an iOS version that syncs\n                with the standard desktop version. Scrivener allows you to capture research notes, images, links, and whatever else you may need to tackle a writing project. As an audio drama producer I write scripts and Scrivener even excels at that.\n                it comes with templates and I’ve used the BBC radio script template for my last three audio drama projects. At <span style=\"color:red\">$45</span> it’s a steal.\n\n              </p>\n            </div>\n            <div class=\"modal-footer\">\n              <button type=\"button\" class=\"btn btn-default reset\" data-dismiss=\"modal\">Close</button>\n              <p>&copy; 2017 Rick Coste Productions, Inc. </p>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"container-fluid equipment-cont\">\n  <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\" id=\"closeButton\">X</button>\n  <div class=\"divTable\">\n    <div class=\"divTableBody\">\n      <div class=\"divTableRow\">\n        <div class=\"divTableCell\" id=\"mxl-trans\">\n          <form class=\"addItemButton\">\n            <div class=\"form-group\">\n              <input type=\"text\" class=\"title-font\" name=\"item[name]\" value=\"MXL V900\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"text\" class=\"price-font\" name=\"item[price]\" value=\"$199.00\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"hidden\" class=\"url-font\" name=\"item[url]\" value=\"http://www.mxlmics.com/\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"hidden\" name=\"item[category]\" value=\"Equipment\" readonly>\n            </div>\n            <button type=\"button\" class=\"btn btn-link info-font\" data-toggle=\"modal\" data-target=\"#mxl-modal\">More Information</button>\n            <br>\n            <button class=\"btn btn-success adder\" type=\"submit\"><span class=\"glyphicon glyphicon-plus\"></span>Add to List</button>\n          </form>\n        </div>\n        <div class=\"divTableCell\" id=\"shure-trans\">\n          <form class=\"addItemButton\">\n            <div class=\"form-group\">\n              <input type=\"text\" class=\"title-font\" name=\"item[name]\" value=\"Shure SM57\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"text\" class=\"price-font\" name=\"item[price]\" value=\"$99.00\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"hidden\" name=\"item[category]\" value=\"Equipment\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"hidden\" class=\"url-font\" name=\"item[url]\" value=\"http://www.shure.com/americas/products/microphones/sm/sm57-instrument-microphone\" readonly>\n            </div>\n            <button type=\"button\" class=\"btn btn-link info-font\" data-toggle=\"modal\" data-target=\"#shure-modal\">More Information</button>\n            <br>\n            <button class=\"btn btn-success adder\" type=\"submit\"><span class=\"glyphicon glyphicon-plus\"></span>Add to List</button>\n          </form>\n        </div>\n        <div class=\"divTableCell\" id=\"mixer-trans\">\n          <form class=\"addItemButton\">\n            <div class=\"form-group\">\n              <input type=\"text\" class=\"title-font\" name=\"item[name]\" value=\"Mixer\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"text\" class=\"price-font\" name=\"item[price]\" value=\"$69.99\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"hidden\" name=\"item[category]\" value=\"Equipment\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"hidden\" class=\"url-font\" name=\"item[url]\" value=\"http://www.guitarcenter.com/Behringer/Xenyx-1002-1274115050170.gc\" readonly>\n            </div>\n            <button type=\"button\" class=\"btn btn-link info-font\" data-toggle=\"modal\" data-target=\"#mixer-modal\">More Information</button>\n            <br>\n            <button class=\"btn btn-success adder\" type=\"submit\"><span class=\"glyphicon glyphicon-plus\"></span>Add to List</button>\n          </form>\n        </div>\n        <div class=\"divTableCell\" id=\"mdx-trans\">\n          <form class=\"addItemButton\">\n            <div class=\"form-group\">\n              <input type=\"text\" class=\"title-font\" name=\"item[name]\" value=\"MDX 4600\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"text\" class=\"price-font\" name=\"item[price]\" value=\"$149.99\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"hidden\" name=\"item[category]\" value=\"Equipment\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"hidden\" class=\"url-font\" name=\"item[url]\" value=\"https://www.music-group.com/Categories/Behringer/Signal-Processors/Compressors-Limiters/MDX4600/p/P0179\" readonly>\n            </div>\n            <button type=\"button\" class=\"btn btn-link info-font\" data-toggle=\"modal\" data-target=\"#comp-modal\">More Information</button>\n            <br>\n            <button class=\"btn btn-success adder\" type=\"submit\"><span class=\"glyphicon glyphicon-plus\"></span>Add to List</button>\n          </form>\n        </div>\n      </div>\n      <div class=\"divTableRow\">\n        <div class=\"divTableCell\" id=\"tascam-trans\">\n          <form class=\"addItemButton\">\n            <div class=\"form-group\">\n              <input type=\"text\" class=\"title-font\" name=\"item[name]\" value=\"Tascam DR5\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"text\" class=\"price-font\" name=\"item[price]\" value=\"$78.00\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"hidden\" name=\"item[category]\" value=\"Equipment\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"hidden\" class=\"url-font\" name=\"item[url]\" value=\"http://tascam.com/product/dr-05/\" readonly>\n            </div>\n            <button type=\"button\" class=\"btn btn-link info-font\" data-toggle=\"modal\" data-target=\"#tascam-modal\">More Information</button>\n            <br>\n            <button class=\"btn btn-success adder\" type=\"submit\"><span class=\"glyphicon glyphicon-plus\"></span>Add to List</button>\n          </form>\n        </div>\n        <div class=\"divTableCell\">&nbsp;</div>\n        <div class=\"divTableCell\">&nbsp;</div>\n        <div class=\"divTableCell\">&nbsp;</div>\n      </div>\n    </div>\n  </div>\n  <!-- DivTable.com -->\n  <!-- /.row -->\n</div>\n\n<!--  MXL V900 -->\n<div class=\"modal fade\" id=\"mxl-modal\">\n  <div class=\"modal-dialog\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">×</button>\n        <h4 class=\"modal-title\">MXL V900</h4>\n      </div>\n      <div class=\"modal-body\">\n        <div class=\"pos section\">\n          <div class=\"vis pos-2 size cont\">\n            <div class=\"vis pos-3 size-2 colwrapper\">\n              <div class=\"vis pos-3 size-3 cont\">\n                <picture class=\"img-2\">\n                  <source srcset=\"https://s3.amazonaws.com/podtools/mxl.jpg\">\n                  <img src=\"https://s3.amazonaws.com/podtools/mxl.jpg\" alt=\"\" class=\"js img-logo\">\n                </picture>\n              </div>\n              <div class=\"vis pos-4 size-4 cont\">\n                <div class=\"cont\">\n                  <p class=\"link-font\"><a target=\"_blank\" href=\"http://www.mxlmics.com/\">http://www.mxlmics.com/</a></p>\n                </div>\n              </div>\n              <div class=\"vis pos-5 size-5 cont\">\n                <div class=\"vis pos-6 size-6 cont-2\">\n                  <div class=\"cont\">\n                    <p class=\"rick-font\">Rick's Pick</p>\n                  </div>\n                </div>\n                <div class=\"vis pos-7 size-7 cont-3\">\n                  <picture class=\"img-4\">\n                    <source srcset=\"https://s3.amazonaws.com/podtools/ok-512.png\">\n                    <img src=\"https://s3.amazonaws.com/podtools/ok-512.png\" alt=\"\" class=\"js-2 img-checkmark\">\n                  </picture>\n                </div>\n                <br>\n                <div class=\"vis pos-8 size-6 cont-4\">\n                </div>\n              </div>\n            </div>\n            <div class=\"vis pos-9 size-8 cont\">\n              <div class=\"cont\">\n                <p class=\"para\">\n                  This is my mic. The MXL-V900. Did I need one so big? No. But it looks cool doesn’t it? Its appearance reminds me of one you would find in an old time radio studio. I bought it after it was recommended to me by podcaster Micah Hanks. It’s a condenser mic which\n                  means it picks up almost everything, and that can be a good thing. This mic looks amazing on my desk next to my iMac and sometimes beauty is everything (plus it sounds great!). The last price I saw for it new was around <span style=\"color:red\">$199.00</span>.\n                </p>\n              </div>\n              <div class=\"modal-footer\">\n                <button type=\"button\" class=\"btn btn-default reset\" data-dismiss=\"modal\">Close</button>\n                <p>&copy; 2017 Rick Coste Productions, Inc. </p>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n\n<!--  Shure -->\n<div class=\"modal fade\" id=\"shure-modal\">\n  <div class=\"modal-dialog\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">×</button>\n        <h4 class=\"modal-title\">Shure SM57</h4>\n      </div>\n      <div class=\"modal-body\">\n        <div class=\"pos section\">\n          <div class=\"vis pos-2 size cont\">\n            <div class=\"vis pos-3 size-2 colwrapper\">\n              <div class=\"vis pos-3 size-3 cont\">\n                <picture class=\"img-2\">\n                  <source srcset=\"https://s3.amazonaws.com/podtools/shure.jpg\">\n                  <img src=\"https://s3.amazonaws.com/podtools/shure.jpg\" alt=\"\" class=\"js img-logo\">\n                </picture>\n              </div>\n              <div class=\"vis pos-4 size-4 cont\">\n                <div class=\"cont\">\n                  <p class=\"link-font\"><a target=\"_blank\" href=\"http://www.shure.com/americas/products/microphones/sm/sm57-instrument-microphone\">http://www.shure.com/americas/products/microphones/sm/sm57-instrument-microphone</a></p>\n                </div>\n              </div>\n              <div class=\"vis pos-5 size-5 cont\">\n                <div class=\"vis pos-6 size-6 cont-2\">\n                </div>\n                <br>\n                <div class=\"vis pos-8 size-6 cont-4\">\n                </div>\n              </div>\n            </div>\n            <div class=\"vis pos-9 size-8 cont\">\n              <div class=\"cont\">\n                <p class=\"para\">\n                  When I was heavily into music production (alone in my basement with a four track recorder, drum kit, and a bunch of guitars) I bought a Shure SM57 to mic my bass drum. It then turned into my go-to mic for recording my acoustic guitar. Today, twenty years\n                  later, I still have that mic and I use it for quick audio drops. It’s been used to record narration and I’ve recorded entire podcast episodes using it. The SM57 is a classic for a reason. Walk into any music store and you will be able\n                  to find new and used ones. New ones start around <span style=\"color:red\">$99.00</span>. For a mic that will literally last decades it’s a great deal.\n\n                </p>\n              </div>\n              <div class=\"modal-footer\">\n                <button type=\"button\" class=\"btn btn-default reset\" data-dismiss=\"modal\">Close</button>\n                <p>&copy; 2017 Rick Coste Productions, Inc. </p>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n\n\n<!--  Mixer -->\n<div class=\"modal fade\" id=\"mixer-modal\">\n  <div class=\"modal-dialog\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">×</button>\n        <h4 class=\"modal-title\">Mixer</h4>\n      </div>\n      <div class=\"modal-body\">\n        <div class=\"pos section\">\n          <div class=\"vis pos-2 size cont\">\n            <div class=\"vis pos-3 size-2 colwrapper\">\n              <div class=\"vis pos-3 size-3 cont\">\n                <picture class=\"img-2\">\n                  <source srcset=\"https://s3.amazonaws.com/podtools/xenyx.jpg\">\n                  <img src=\"https://s3.amazonaws.com/podtools/xenyx.jpg\" alt=\"\" class=\"js img-logo\">\n                </picture>\n              </div>\n              <div class=\"vis pos-4 size-4 cont\">\n                <div class=\"cont\">\n                  <p class=\"link-font\"><a target=\"_blank\" href=\"http://www.guitarcenter.com/Behringer/Xenyx-1002-1274115050170.gc\">http://www.guitarcenter.com/Behringer/Xenyx-1002-1274115050170.gc</a></p>\n                </div>\n              </div>\n              <div class=\"vis pos-5 size-5 cont\">\n                <div class=\"vis pos-6 size-6 cont-2\">\n                </div>\n                <br>\n                <div class=\"vis pos-8 size-6 cont-4\">\n                </div>\n              </div>\n            </div>\n            <div class=\"vis pos-9 size-8 cont\">\n              <div class=\"cont\">\n                <p class=\"para\">\n                  You don’t need a mixer to podcast, but if you do decide to get one then I would recommend picking up a small Behringer.  I use the Xenyx1002. I’ve used a few mixers in my time and this one is easy, dependable, and has an ‘effects send’ patch (which I really wanted). I highly recommend\n                  it. The one I grabbed off of the shelf was new at <span style=\"color:red\">$70.00</span> but you can find used ones on eBay.\n                </p>\n              </div>\n              <div class=\"modal-footer\">\n                <button type=\"button\" class=\"btn btn-default reset\" data-dismiss=\"modal\">Close</button>\n                <p>&copy; 2017 Rick Coste Productions, Inc. </p>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n\n<!--  Compressor -->\n<div class=\"modal fade\" id=\"comp-modal\">\n  <div class=\"modal-dialog\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">×</button>\n        <h4 class=\"modal-title\">MDX4600</h4>\n      </div>\n      <div class=\"modal-body\">\n        <div class=\"pos section\">\n          <div class=\"vis pos-2 size cont\">\n            <div class=\"vis pos-3 size-2 colwrapper\">\n              <div class=\"vis pos-3 size-3 cont\">\n                <picture class=\"img-2\">\n                  <source srcset=\"https://s3.amazonaws.com/podtools/mdx4600.jpg\">\n                  <img src=\"https://s3.amazonaws.com/podtools/mdx4600.jpg\" alt=\"\" class=\"js img-logo\">\n                </picture>\n              </div>\n              <div class=\"vis pos-4 size-4 cont\">\n                <div class=\"cont\">\n                  <p class=\"link-font\"><a target=\"_blank\" href=\"https://www.music-group.com/Categories/Behringer/Signal-Processors/Compressors-Limiters/MDX4600/p/P0179\">https://www.music-group.com/Categories/Behringer/Signal-Processors/Compressors-Limiters/MDX4600/p/P0179</a></p>\n                </div>\n              </div>\n              <div class=\"vis pos-5 size-5 cont\">\n                <div class=\"vis pos-6 size-6 cont-2\">\n                </div>\n                <div class=\"cont\">\n                  <p class=\"rick-font\">Rick's Pick</p>\n                </div>\n              </div>\n              <br>\n              <div class=\"vis pos-8 size-6 cont-4\">\n              </div>\n            </div>\n          </div>\n          <div class=\"vis pos-9 size-8 cont\">\n            <div class=\"cont\">\n              <p class=\"para\">\n                Do you need this? No. Do you want this? Maybe. When I started podcasting I listened to Cliff Ravenscraft who hosts a show called 'The Podcast Answerman'. Cliff has the Behringer MDX4600 firmly situated in his production loop and so I wanted one too. I found\n                a used one on eBay. A new one will set you back around <span style=\"color:red\">$149.99</span>. One word of caution - it’s not an easy device to master without some instruction. If you do pick one up feel free to hit me up\n                on what my settings are (again thanks to Cliff). I’ll be happy to help!\n\n\n              </p>\n            </div>\n            <div class=\"modal-footer\">\n              <button type=\"button\" class=\"btn btn-default reset\" data-dismiss=\"modal\">Close</button>\n              <p>&copy; 2017 Rick Coste Productions, Inc. </p>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n</div>\n\n<!--  TAscam -->\n<div class=\"modal fade\" id=\"tascam-modal\">\n  <div class=\"modal-dialog\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">×</button>\n        <h4 class=\"modal-title\">Tascam DR5</h4>\n      </div>\n      <div class=\"modal-body\">\n        <div class=\"pos section\">\n          <div class=\"vis pos-2 size cont\">\n            <div class=\"vis pos-3 size-2 colwrapper\">\n              <div class=\"vis pos-3 size-3 cont\">\n                <picture class=\"img-2\">\n                  <source srcset=\"https://s3.amazonaws.com/podtools/tascam.jpg\">\n                  <img src=\"https://s3.amazonaws.com/podtools/tascam.jpg\" alt=\"\" class=\"js img-logo\">\n                </picture>\n              </div>\n              <div class=\"vis pos-4 size-4 cont\">\n                <div class=\"cont\">\n                  <p class=\"link-font\"><a target=\"_blank\" href=\"http://tascam.com/product/dr-05/\">http://tascam.com/product/dr-05/</a></p>\n                </div>\n              </div>\n              <div class=\"vis pos-5 size-5 cont\">\n                <div class=\"vis pos-6 size-6 cont-2\">\n                </div>\n                <div class=\"cont\">\n                  <p class=\"rick-font\">Rick's Pick</p>\n                </div>\n              </div>\n              <div class=\"vis pos-7 size-7 cont-3\">\n                <picture class=\"img-4\">\n                  <source srcset=\"https://s3.amazonaws.com/podtools/ok-512.png\">\n                  <img src=\"https://s3.amazonaws.com/podtools/ok-512.png\" alt=\"\" class=\"js-2 img-checkmark\">\n                </picture>\n              </div>\n              <br>\n              <div class=\"vis pos-8 size-6 cont-4\">\n              </div>\n            </div>\n          </div>\n          <div class=\"vis pos-9 size-8 cont\">\n            <div class=\"cont\">\n              <p class=\"para\">\n                Ah yes. Tascam. My love of Tascam recording products again goes back to my music production days. My first recorder was a four track cassette recorder. I still have it (but only to play those old unmixed tapes on). Many podcasters record direct to their\n                desktops or laptops and, while this is certainly an option and shouldn’t cost much, I prefer using a standalone device that was created specifically for the job. That’s where my Tascam DR5 comes in. It’s a digital recorder and one that\n                makes it very easy to transfer the recorded, raw file to my iMac for editing. A new one will run around <span style=\"color:red\">$78.00</span> but you can find used ones on eBay.\n\n              </p>\n            </div>\n            <div class=\"modal-footer\">\n              <button type=\"button\" class=\"btn btn-default reset\" data-dismiss=\"modal\">Close</button>\n              <p>&copy; 2017 Rick Coste Productions, Inc. </p>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"container-fluid peripheral-cont\">\n  <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\" id=\"closeButton\">X</button>\n  <div class=\"divTable\">\n    <div class=\"divTableBody\">\n      <div class=\"divTableRow\">\n        <div class=\"divTableCell\" id=\"stand-trans\">\n          <form class=\"addItemButton\">\n            <div class=\"form-group\">\n              <input type=\"text\" class=\"title-font\" name=\"item[name]\" value=\"Mic Stand\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"text\" class=\"price-font\" name=\"item[price]\" value=\"$18.00 +\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"hidden\" class=\"url-font\" name=\"item[url]\" value=\"http://www.guitarcenter.com/Microphone-Stands.gc\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"hidden\" name=\"item[category]\" value=\"Peripheral\" readonly>\n            </div>\n            <button type=\"button\" class=\"btn btn-link info-font\" data-toggle=\"modal\" data-target=\"#stand-modal\">More Information</button>\n            <br>\n            <button class=\"btn btn-success adder\" type=\"submit\"><span class=\"glyphicon glyphicon-plus\"></span>Add to List</button>\n          </form>\n        </div>\n        <div class=\"divTableCell\" id=\"filter-trans\">\n          <form class=\"addItemButton\">\n            <div class=\"form-group\">\n              <input type=\"text\" class=\"title-font\" name=\"item[name]\" value=\"Pop Filter\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"text\" class=\"price-font\" name=\"item[price]\" value=\"$9.99 +\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"hidden\" name=\"item[category]\" value=\"Peripheral\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"hidden\" class=\"url-font\" name=\"item[url]\" value=\"http://www.guitarcenter.com/Pop-Filters.gc\" readonly>\n            </div>\n            <button type=\"button\" class=\"btn btn-link info-font\" data-toggle=\"modal\" data-target=\"#filter-modal\">More Information</button>\n            <br>\n            <button class=\"btn btn-success adder\" type=\"submit\"><span class=\"glyphicon glyphicon-plus\"></span>Add to List</button>\n          </form>\n        </div>\n        <div class=\"divTableCell\" id=\"ipad-trans\">\n          <form class=\"addItemButton\">\n            <div class=\"form-group\">\n              <input type=\"text\" class=\"title-font\" name=\"item[name]\" value=\"iPad Stand\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"text\" class=\"price-font\" name=\"item[price]\" value=\"$29.99 +\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"hidden\" name=\"item[category]\" value=\"Peripheral\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"hidden\" class=\"url-font\" name=\"item[url]\" value=\"http://www.guitarcenter.com/search?Ns=r&Ntt=ipad+stand\" readonly>\n            </div>\n            <button type=\"button\" class=\"btn btn-link info-font\" data-toggle=\"modal\" data-target=\"#ipad-modal\">More Information</button>\n            <br>\n            <button class=\"btn btn-success adder\" type=\"submit\"><span class=\"glyphicon glyphicon-plus\"></span>Add to List</button>\n          </form>\n        </div>\n        <div class=\"divTableCell\" id=\"cables-trans\">\n          <form class=\"addItemButton\">\n            <div class=\"form-group\">\n              <input type=\"text\" class=\"title-font\" name=\"item[name]\" value=\"Cables\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"text\" class=\"price-font\" name=\"item[price]\" value=\"$5.00 +\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"hidden\" name=\"item[category]\" value=\"Peripherals\" readonly>\n            </div>\n            <div class=\"form-group\">\n              <input type=\"hidden\" class=\"url-font\" name=\"item[url]\" value=\"http://www.guitarcenter.com/Cables-Snakes.gc\" readonly>\n            </div>\n            <button type=\"button\" class=\"btn btn-link info-font\" data-toggle=\"modal\" data-target=\"#cables-modal\">More Information</button>\n            <br>\n            <button class=\"btn btn-success adder\" type=\"submit\"><span class=\"glyphicon glyphicon-plus\"></span>Add to List</button>\n          </form>\n        </div>\n      </div>\n      <div class=\"divTableRow\">\n        <div class=\"divTableCell\">&nbsp;</div>\n        <div class=\"divTableCell\">&nbsp;</div>\n        <div class=\"divTableCell\">&nbsp;</div>\n        <div class=\"divTableCell\">&nbsp;</div>\n      </div>\n    </div>\n  </div>\n  <!-- DivTable.com -->\n  <!-- /.row -->\n</div>\n\n<!--  Mic Stands -->\n<div class=\"modal fade\" id=\"stand-modal\">\n  <div class=\"modal-dialog\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">×</button>\n        <h4 class=\"modal-title\">Mic Stands</h4>\n      </div>\n      <div class=\"modal-body\">\n        <div class=\"pos section\">\n          <div class=\"vis pos-2 size cont\">\n            <div class=\"vis pos-3 size-2 colwrapper\">\n              <div class=\"vis pos-3 size-3 cont\">\n                <picture class=\"img-2\">\n                  <source srcset=\"https://s3.amazonaws.com/podtools/mic_stand.jpg\">\n                  <img src=\"https://s3.amazonaws.com/podtools/mic_stand.jpg\" alt=\"\" class=\"js img-logo\">\n                </picture>\n              </div>\n              <div class=\"vis pos-4 size-4 cont\">\n                <div class=\"cont\">\n                  <p class=\"link-font\"><a target=\"_blank\" href=\"http://www.guitarcenter.com/Microphone-Stands.gc\">http://www.guitarcenter.com/Microphone-Stands.gc</a></p>\n                </div>\n              </div>\n              <div class=\"vis pos-9 size-8 cont\">\n                <div class=\"cont\">\n                  <p class=\"para\">\n                    The kind of mic stand depends on the kind of show you are doing. If you are sitting at a desk you may only need a small tabletop stand. I used one of these for years and still do when I record the comments that close a show. Perhaps you prefer to stand up\n                    as opposed to sitting? Some voice coaches will tell you that this enhances your vocal performance and allows your diaphragm to expand. It’s all personal preference and you can find almost any style stand for less than $20.\n                  </p>\n                </div>\n                <div class=\"modal-footer\">\n                  <button type=\"button\" class=\"btn btn-default reset\" data-dismiss=\"modal\">Close</button>\n                  <p>&copy; 2017 Rick Coste Productions, Inc. </p>\n                </div>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n\n<!--  Filter Modal -->\n<div class=\"modal fade\" id=\"filter-modal\">\n  <div class=\"modal-dialog\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">×</button>\n        <h4 class=\"modal-title\">Pop Filters</h4>\n      </div>\n      <div class=\"modal-body\">\n        <div class=\"pos section\">\n          <div class=\"vis pos-2 size cont\">\n            <div class=\"vis pos-3 size-2 colwrapper\">\n              <div class=\"vis pos-3 size-3 cont\">\n                <picture class=\"img-2\">\n                  <source srcset=\"https://s3.amazonaws.com/podtools/filter.jpg\">\n                  <img src=\"https://s3.amazonaws.com/podtools/filter.jpg\" alt=\"\" class=\"js img-logo\">\n                </picture>\n              </div>\n              <div class=\"vis pos-4 size-4 cont\">\n                <div class=\"cont\">\n                  <p class=\"link-font\"><a target=\"_blank\" href=\"http://www.guitarcenter.com/Pop-Filters.gc\">http://www.guitarcenter.com/Pop-Filters.gc</a></p>\n                </div>\n              </div>\n              <div class=\"vis pos-5 size-5 cont\">\n                <div class=\"vis pos-6 size-6 cont-2\">\n                </div>\n                <br>\n                <div class=\"vis pos-8 size-6 cont-4\">\n                </div>\n              </div>\n            </div>\n            <div class=\"vis pos-9 size-8 cont\">\n              <div class=\"cont\">\n                <p class=\"para\">\n                  A pop screen (or pop filter) isn’t an essential purchase but you might wish you had one the first time you encounter a ‘plosive’ in your recording. What’s a ‘plosive’? It’s when a small explosion of air hits the mic, usually following a word with\n                  a ‘p’ in it. You’ll also hear it referred to as popping “p’s”. You can buy a small foam filter that slips over your mic or a round screen that attaches to your mic stand. I prefer the screen as it forces you to keep some distance between\n                  you and the mic.\n\n                </p>\n              </div>\n              <div class=\"modal-footer\">\n                <button type=\"button\" class=\"btn btn-default reset\" data-dismiss=\"modal\">Close</button>\n                <p>&copy; 2017 Rick Coste Productions, Inc. </p>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n\n\n<!--  iPad Stand -->\n<div class=\"modal fade\" id=\"ipad-modal\">\n  <div class=\"modal-dialog\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">×</button>\n        <h4 class=\"modal-title\">iPad Stand</h4>\n      </div>\n      <div class=\"modal-body\">\n        <div class=\"pos section\">\n          <div class=\"vis pos-2 size cont\">\n            <div class=\"vis pos-3 size-2 colwrapper\">\n              <div class=\"vis pos-3 size-3 cont\">\n                <picture class=\"img-2\">\n                  <source srcset=\"https://s3.amazonaws.com/podtools/ipad.jpg\">\n                  <img src=\"https://s3.amazonaws.com/podtools/ipad.jpg\" alt=\"\" class=\"js img-logo\">\n                </picture>\n              </div>\n              <div class=\"vis pos-4 size-4 cont\">\n                <div class=\"cont\">\n                  <p class=\"link-font\"><a target=\"_blank\" href=\"http://www.guitarcenter.com/search?Ns=r&Ntt=ipad+stand\">http://www.guitarcenter.com/search?Ns=r&Ntt=ipad+stand</a></p>\n                </div>\n              </div>\n              <div class=\"vis pos-5 size-5 cont\">\n                <div class=\"vis pos-6 size-6 cont-2\">\n                </div>\n                <br>\n                <div class=\"vis pos-8 size-6 cont-4\">\n                </div>\n              </div>\n            </div>\n            <div class=\"vis pos-9 size-8 cont\">\n              <div class=\"cont\">\n                <p class=\"para\">\n                  If you do opt for to stand when you speak into a mic you might find that reading lines from an iPad is the way to go. It beats having to record and/or edit the sound of paper shuffling when you (or a voice artist) flips to the next page. Having\n                  an attachment to hold your iPad at eye level while you read your lines is, in a word, “awesome”.\n                </p>\n              </div>\n              <div class=\"modal-footer\">\n                <button type=\"button\" class=\"btn btn-default reset\" data-dismiss=\"modal\">Close</button>\n                <p>&copy; 2017 Rick Coste Productions, Inc. </p>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n\n<!--  Cables -->\n<div class=\"modal fade\" id=\"cables-modal\">\n  <div class=\"modal-dialog\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">×</button>\n        <h4 class=\"modal-title\">Cables</h4>\n      </div>\n      <div class=\"modal-body\">\n        <div class=\"pos section\">\n          <div class=\"vis pos-2 size cont\">\n            <div class=\"vis pos-3 size-2 colwrapper\">\n              <div class=\"vis pos-3 size-3 cont\">\n                <picture class=\"img-2\">\n                  <source srcset=\"https://s3.amazonaws.com/podtools/mic_cable.jpg\">\n                  <img src=\"https://s3.amazonaws.com/podtools/mic_cable.jpg\" alt=\"\" class=\"js img-logo\">\n                </picture>\n              </div>\n              <div class=\"vis pos-4 size-4 cont\">\n                <div class=\"cont\">\n                  <p class=\"link-font\"><a target=\"_blank\" href=\"http://www.guitarcenter.com/Cables-Snakes.gc\">http://www.guitarcenter.com/Cables-Snakes.gc</a></p>\n                </div>\n              </div>\n              <div class=\"vis pos-5 size-5 cont\">\n                <div class=\"vis pos-6 size-6 cont-2\">\n                </div>\n\n              </div>\n              <br>\n              <div class=\"vis pos-8 size-6 cont-4\">\n              </div>\n            </div>\n          </div>\n          <div class=\"vis pos-9 size-8 cont\">\n            <div class=\"cont\">\n              <p class=\"para\">\n                Not much to say here. You need cords. Depending on your setup that might mean only buying a mic cord but you don’t want to sit down to record your inaugural episode only to find that you are missing something essential.\n\n\n              </p>\n            </div>\n            <div class=\"modal-footer\">\n              <button type=\"button\" class=\"btn btn-default reset\" data-dismiss=\"modal\">Close</button>\n              <p>&copy; 2017 Rick Coste Productions, Inc. </p>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<iframe style=\"border: none\" src=\"//html5-player.libsyn.com/embed/destination/id/349835/height/900/width/700/theme/custom/autoplay/no/autonext/no/thumbnail/yes/preload/no/no_addthis/no/direction/forward/no-cache/true/render-playlist/yes/custom-color/c2590b/\"\n    height=\"900\" width=\"700\" scrolling=\"no\" allowfullscreen webkitallowfullscreen mozallowfullscreen oallowfullscreen msallowfullscreen></iframe>\n  <div class=\"modal-footer\">\n    <button type=\"button\" class=\"btn btn-default reset\" data-dismiss=\"modal\">Close</button>\n    <p>&copy; 2017 Rick Coste Productions, Inc. </p>\n  </div>\n";
	},"useData":true});
